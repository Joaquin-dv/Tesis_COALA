        ...
        <section class="informacion_de_coala">
            <article class="carta_informacion" id="carta_informacion">
                ...
                <section class="informacion">
                    <h2>Comunidad</h2>
                    <p>Una comunidad que aprende unida
                        Cada apunte compartido es una herramienta más
                        para crecer.
                        Aprendé con otros, desde otros puntos de vista, y
                        sin perder ni una hoja más.</p>
            ...
            <article class="carta_informacion">
                ...
                <section class="informacion">
                    <h2>Alumnos</h2>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veritatis exercitationem iste, itaque
                        voluptatem cum distinctio voluptas qui, laudantium culpa unde provident. Excepturi distinctio
                        exercitationem, quas odio perspiciatis reiciendis laborum earum?</p>
